...
//        [Route("api/CMS/GetCMSMaster/{CMSMasterId}")]
//        [HttpGet]
//        public HttpResponseMessage GetCMSMasterDetail(int? CMSMasterId)
//        {
//            try
//            {
//                CMSMasterResponse response = new CMSMasterResponse();
//                if (CMSMasterId != null && CMSMasterId.HasValue)
//                {
//                    if (CMSMasterId == 0)
//                        return Request.CreateErrorResponse(HttpStatusCode.NotAcceptable, "CMS ID is invalid. Cannot find CMSId in System");
//                    using (ColspEntities db = new ColspEntities())
//                    {
//                        var GetCMS = db.CMSMasters.Where(c => c.CMSMasterId == CMSMasterId).FirstOrDefault();
//                        if (GetCMS != null)
//                        {
...
//                            var SchedulerLists = (from map in db.CMSMasterSchedulerMaps.Where(c => c.CMSMasterId == CMSMasterId)
